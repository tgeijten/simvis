...
namespace vis
{
	...
	node( &parent )
	{
		x_arrow = mesh( *this, xo::capsule{ radius, length.x }, color::red(), detail );
		y_arrow = mesh( *this, xo::capsule{ radius, length.y }, color::green(), detail );
		z_arrow = mesh( *this, xo::capsule{ radius, length.z }, color::blue(), detail );
